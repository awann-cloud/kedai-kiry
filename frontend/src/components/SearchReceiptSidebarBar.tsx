/**
 * SearchReceiptSidebarBar.tsx - Bar Receipt Search Sidebar
 * 
 * A sliding sidebar that appears from the left when clicking the Bar profile icon.
...
import BarProfileIconPaths from "../imports/BarProfileIconPaths";
import StatusCirclesPaths from "../imports/StatusCirclesPaths";
import { imgGroup } from "../imports/PlaceholderSquare";
import BarReceiptIconPaths from "../imports/BarReceiptIconPaths";
...
interface SearchReceiptSidebarBarProps {
  isOpen: boolean;
  orders: Order[];
  onClose: () => void;
  onGoHome: () => void;
...
export default function SearchReceiptSidebarBar({
  isOpen,
  orders,
  onClose,
  onGoHome
}: SearchReceiptSidebarBarProps) {
          ...
          <div className="absolute left-[33px] size-[70px] top-[15px] cursor-pointer" onClick={onClose}>
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 80">
              <g>
                ...
                <g>
                  <path d={BarProfileIconPaths.p27360080} fill="white" />
                </g>
              </g>
            </svg>
          </div>
