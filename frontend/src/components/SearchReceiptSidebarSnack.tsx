/**
 * SearchReceiptSidebarSnack.tsx - Snack Receipt Search Sidebar
 * 
 * A sliding sidebar that appears from the left when clicking the Snack profile icon.
...
import SnackCircleIconPaths from "../imports/SnackCircleIconPaths";
import StatusCirclesPaths from "../imports/StatusCirclesPaths";
import { imgGroup } from "../imports/PlaceholderSquare";
import SnackReceiptIconPaths from "../imports/SnackReceiptIconPaths";
...
interface SearchReceiptSidebarSnackProps {
  isOpen: boolean;
  orders: Order[];
  onClose: () => void;
  onGoHome: () => void;
...
export default function SearchReceiptSidebarSnack({
  isOpen,
  orders,
  onClose,
  onGoHome
}: SearchReceiptSidebarSnackProps) {
          ...
          <div className="absolute left-[33px] size-[70px] top-[15px] cursor-pointer" onClick={onClose}>
            <svg className="block size-full" fill="none" preserveAspectRatio="xMidYMid meet" viewBox="0 0 80 80">
              <g>
                ...
                <g>
                  <path d={SnackCircleIconPaths.p16eba280} fill="white" />
                  <path d={SnackCircleIconPaths.p26109580} fill="white" />
                  <path d={SnackCircleIconPaths.p35b6d700} fill="white" />
                  <path d={SnackCircleIconPaths.p128d1df0} fill="white" />
                  <path d={SnackCircleIconPaths.p2ba7adf2} fill="white" />
                  <path d={SnackCircleIconPaths.p11eba280} fill="white" />
                  <path d={SnackCircleIconPaths.p1d957e00} fill="white" />
                  <path d={SnackCircleIconPaths.p223aa700} fill="white" />
                  <path d={SnackCircleIconPaths.pe4c4800} fill="white" />
                  <path d={SnackCircleIconPaths.p91ed080} fill="white" />
                  <path d={SnackCircleIconPaths.p12026900} fill="white" />
                  <path d={SnackCircleIconPaths.p1d8cfe00} fill="white" />
                </g>
              </g>
            </svg>
          </div>
